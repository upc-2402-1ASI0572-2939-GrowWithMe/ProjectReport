...
| TS001-T1        | Crear API para guardar objetivos            | Desarrollar un endpoint de API para recibir y almacenar los datos del formulario de objetivos (manuales y de sensores) en la base de datos.                                                                     | US01, US02    | 3                       |
| TS001-T2       | Implementar lógica combinación datos objetivos | Desarrollar la lógica backend para combinar y procesar los datos manuales ingresados con los datos de sensores en tiempo real al guardar los objetivos.                                                        | US01, US02    | 5                       |
| TS001-T3   | Crear interfaz formulario objetivos         | Desarrollar la interfaz de usuario (frontend) para que el agricultor pueda ingresar sus objetivos, incluyendo campos para datos manuales y visualización de datos de sensores.                                   | US01          | 4                       |
| TS001-T4   | Crear API para consultar objetivos          | Desarrollar un endpoint de API para recuperar y enviar los datos de los objetivos almacenados para su visualización.                                                                                              | US03          | 2                       |
| TS001-T5     | Desarrollar vista consulta objetivos        | Desarrollar la interfaz de usuario (frontend) para mostrar los objetivos del agricultor y permitir el monitoreo basado en datos en tiempo real.                                                                  | US03          | 5                       |
| TS001-T6   | Implementar lógica seguimiento objetivos    | Desarrollar la lógica backend para calcular y mostrar el progreso de los objetivos utilizando los datos en tiempo real de los sensores.                                                                         | US04          | 4                       |
| TS001-T7   | Integrar visualización progreso objetivos   | Integrar la visualización del progreso de los objetivos en la interfaz de usuario, mostrando el impacto de las acciones automatizadas.                                                                           | US04          | 3                       |
| TS002-T1  | Crear API para guardar estrategia cultivo    | Desarrollar un endpoint de API para recibir y almacenar los datos del formulario de estrategia de cultivo, incluyendo recomendaciones basadas en datos.                                                          | US05, US06    | 3                       |
| TS002-T2     | Implementar lógica validación estrategia    | Desarrollar la lógica backend para validar la estrategia de cultivo ingresada con los datos de sensores para asegurar su pertinencia.                                                                          | US06          | 4                       |
| TS002-T3    | Crear interfaz formulario estrategia        | Desarrollar la interfaz de usuario (frontend) para que el agricultor pueda ingresar su estrategia de cultivo y ver recomendaciones basadas en datos.                                                              | US05          | 4                       |
| TS002-T4    | Crear API para consultar estrategias        | Desarrollar un endpoint de API para recuperar y enviar los datos de las estrategias de cultivo almacenadas para su visualización.                                                                                 | US07          | 2                       |
| TS002-T5   | Desarrollar vista consulta estrategias      | Desarrollar la interfaz de usuario (frontend) para mostrar las estrategias de cultivo y los indicadores en tiempo real para evaluar su efectividad.                                                              | US07          | 5                       |
| TS002-T6   | Implementar lógica seguimiento impacto estrategia | Desarrollar la lógica backend para calcular y mostrar el impacto de la estrategia en la productividad utilizando datos en tiempo real.                                                                           | US08          | 5                       |
| TS002-T7     | Integrar visualización impacto estrategia   | Integrar la visualización del impacto de la estrategia en la interfaz de usuario, mostrando las mejoras o la necesidad de ajustes.                                                                               | US08          | 3                       |
| TS003-T1   | Crear API para registrar actividades         | Desarrollar un endpoint de API para recibir y almacenar los datos del formulario de registro de actividades (manuales y datos complementarios).                                                                 | US09, US10    | 3                       |
| TS003-T2    | Implementar lógica integración datos actividad | Desarrollar la lógica backend para integrar los datos manuales del registro de actividades con los datos automáticos de los sensores.                                                                       | US09, US10    | 4                       |
| TS003-T3    | Crear interfaz formulario registro actividades | Desarrollar la interfaz de usuario (frontend) para que el agricultor pueda registrar sus actividades diarias, con campos para datos manuales y visualización de datos complementarios.                              | US09          | 4                       |
| TS003-T4    | Crear API para consultar actividades         | Desarrollar un endpoint de API para recuperar y enviar los datos del registro de actividades para su visualización y análisis.                                                                                   | US11          | 2                       |
| TS003-T5   | Desarrollar interfaz consulta actividades      | Desarrollar la interfaz de usuario (frontend) para visualizar un resumen y análisis de las actividades, combinando datos manuales y de sensores.                                                                 | US11          | 5                       |
| TS004-T1  | Crear API para registrar datos calidad         | Desarrollar un endpoint de API para recibir y almacenar los datos del formulario de registro de calidad, integrando mediciones de sensores.                                                                     | US12, US13    | 3                       |
